			...
			<div className='search-bar'>
				<form className='date-container-vendas'>       
					<div className='submit-container select-align select-align-filtro voltar-align'>
						{ ajustes.length > 0 ? <button className='btn btn-secondary btn-global btn-pesquisar' onClick={ (e) => { handleVoltar(e) }}>Voltar</button> : <button data-tour="pesquisar-section" className='btn btn-primary btn-global btn-pesquisar' onClick={(e) => handleBusca(e)}>Pesquisar</button>}
					</div>      
				</form>
			</div>
		</>
