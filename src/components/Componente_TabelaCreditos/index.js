			...
			<div className='container-busca'>	
                <span className={`span-busca ${isDarkTheme === true ? 'dark-theme' : 'light-theme'}`}>
                    {dataBuscaInicialCreditos !== dataBuscaFinalCreditos ? 
                        <span dangerouslySetInnerHTML={{__html: `Exibindo Créditos do dia <strong>${dataBuscaInicialCreditos}</strong> ao dia <strong>${dataBuscaFinalCreditos}</strong>`}} /> : 
                        <span dangerouslySetInnerHTML={{__html: `Exibindo Créditos do dia <strong>${dataBuscaInicialCreditos}</strong>`}} />
                    }
                </span>
        	</div>
