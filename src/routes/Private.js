...
import ModalUserActivity from '../components/ModalUserActivity' // Assumes a modal component is available
...
const isTokenAboutToExpire = (token) => {
  ...
  // Check if the token is about to expire within the next 10 minutes (600 seconds)
  const isAboutToExpire = expirationTime - currentTime < 10 * 60 * 1000; // 10 minutes in milliseconds
  ...
  useUserActivity(handleInactivity); // 10 min inactivity timeout
            ...
            <div className='flex-container-private'>
              ...
              <div className='container-private-body'>
                <div className='text-container-private'>
                  <p className='text-private'>Você está inativo faz um tempo. Deseja continuar logado?</p>
                </div>
